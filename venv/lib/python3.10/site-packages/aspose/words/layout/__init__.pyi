...
class PageLayoutCallbackArgs:
    """An argument passed into :meth:`IPageLayoutCallback.notify`To learn more, visit the `Converting to Fixed-page Format <https://docs.aspose.com/words/python-net/converting-to-fixed-page-format/>` documentation article."""
