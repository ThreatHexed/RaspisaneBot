...
class Theme:
    """Represents document Theme, and provides access to main theme parts including :attr:`Theme.major_fonts`, :attr:`Theme.minor_fonts` and :attr:`Theme.colors`To learn more, visit the `Working with Styles and Themes <https://docs.aspose.com/words/python-net/working-with-styles-and-themes/>` documentation article."""
