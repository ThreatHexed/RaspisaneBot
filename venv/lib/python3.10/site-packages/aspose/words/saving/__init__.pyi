...
class HtmlSaveOptions(aspose.words.saving.SaveOptions):
    ...
    def epub_navigation_map_level(self) -> int:
        """Specifies the maximum level of headings populated to the navigation map when exporting to IDPF EPUB, MOBI, or AZW3
        ...
        assign this value to :attr:`HtmlSaveOptions.epub_navigation_map_level`.
...
class ImageSaveOptions(aspose.words.saving.FixedPageSaveOptions):
    ...
    def save_format(self) -> aspose.words.SaveFormat:
        ...
        :attr:`aspose.words.SaveFormat.SVG`.
...
class MarkdownLinkExportMode(Enum):
    ...
    """A link is exported as a reference block if it has roundtrip information or is mentioned more than once
    in a document. In all other cases a link is exported as an inline block."""
    AUTO: int
